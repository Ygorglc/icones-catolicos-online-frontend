...
describe('CadastroPage', () => {
  ...
  it('should register with valid personal and address data', () => { const fixture = TestBed.createComponent(CadastroPage); fixture.detectChanges(); const inputs = fixture.nativeElement.querySelectorAll('input') as NodeListOf<HTMLInputElement>; write(inputs[0], 'Maria Silva'); write(inputs[1], 'maria@teste.com'); write(inputs[2], 'Senha123!'); write(inputs[3], 'Senha123!'); write(inputs[4], '21999999999'); write(inputs[5], '52998224725'); write(inputs[6], '20040002'); write(inputs[7], 'Rua da Assembleia'); write(inputs[8], '10'); write(inputs[10], 'Centro'); write(inputs[11], 'Rio de Janeiro'); const estado = fixture.nativeElement.querySelector('select') as HTMLSelectElement; estado.value = 'RJ'; estado.dispatchEvent(new Event('change')); (fixture.nativeElement.querySelector('form') as HTMLFormElement).dispatchEvent(new Event('submit')); expect(auth.register).toHaveBeenCalledWith({ nome: 'Maria Silva', email: 'maria@teste.com', senha: 'Senha123!', telefone: '21999999999', cpf: '52998224725', cep: '20040002', logradouro: 'Rua da Assembleia', numero: '10', complemento: null, bairro: 'Centro', cidade: 'Rio de Janeiro', uf: 'RJ' }); });
});
